...
import com.example.marvelheroesapp.classes.entityHeroToHeroForRender
import com.example.marvelheroesapp.classes.heroToEntityHero
import com.example.marvelheroesapp.classes.heroToHeroForRender
...
class HeroDetailViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private val heroBD: HeroDataBase = AppDatabase.getDatabase(application).heroBD()
